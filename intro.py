...
def create_fr_intro():
    ...
    À moins d'indication contraire, toutes les statistiques présentées ont été récoltées du <time datetime="2013-06-18">18&nbsp;juin&nbsp;2013</time> au <span class="nowrap"><time datetime=\"""" + lastMonth.strftime("%Y-%m-%d") +"\">"+ french_date.encode('utf8') + """</time></span>. 
